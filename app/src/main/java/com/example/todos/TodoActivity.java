...
public class TodoActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_delete_todo){  //action_delete_all_todos){
            //confirm?
            new AlertDialog.Builder(TodoActivity.this)
                    .setTitle(getString(R.string.action_delete_all_todos))// delete_todo_dialog_title))
                    .setMessage(getString(R.string.action_delete_todos))  //delete_todo_dialog))
